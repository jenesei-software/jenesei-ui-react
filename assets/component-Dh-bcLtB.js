import{m as Oe,l as c,d as J,j as O}from"./styled-components.browser.esm-CyaOpMkv.js";import{j as ve}from"./jsx-runtime-uV6E1Fxi.js";import{r as s}from"./index-CnY36iC1.js";import{r as De,M as Re}from"./index-Dyxk8dpP.js";import{i as Ne}from"./tiny-invariant-DKC21gSL.js";import{S as ke}from"./context-DdocyObD.js";import{J as Le,K as Ce}from"./theme.global-CKNmeFpz.js";import{m as He}from"./proxy-BS1eh56F.js";import{A as je}from"./index-DgedcAJ4.js";const Ve=Oe`
  0% {
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(){function e(d,y){return d===y&&(d!==0||1/d===1/y)||d!==d&&y!==y}typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<"u"&&typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart=="function"&&__REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());var t=s,n=qe,i=typeof Object.is=="function"?Object.is:e,o=n.useSyncExternalStore,u=t.useRef,f=t.useEffect,m=t.useMemo,v=t.useDebugValue;fe.useSyncExternalStoreWithSelector=function(d,y,p,z,a){var r=u(null);if(r.current===null){var x={hasValue:!1,value:null};r.current=x}else x=r.current;r=m(function(){function _($){if(!E){if(E=!0,T=$,$=z($),a!==void 0&&x.hasValue){var h=x.value;if(a(h,$))return w=h}return w=$}if(h=w,i(T,$))return h;var l=z($);return a!==void 0&&a(h,l)?(T=$,h):(T=$,w=l)}var E=!1,T,w,D=p===void 0?null:p;return[function(){return _(y())},D===null?void 0:function(){return _(D())}]},[y,p,z,a]);var b=o(d,r[0],r[1]);return f(function(){x.hasValue=!0,x.value=b},[b]),v(b),b},typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<"u"&&typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop=="function"&&__REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(Error())})();ce.exports=fe;var Ge=ce.exports;function Ue(e,t=n=>n){return Ge.useSyncExternalStoreWithSelector(e.subscribe,()=>e.state,()=>e.state,t,Fe)}function Fe(e,t){if(Object.is(e,t))return!0;if(typeof e!="object"||e===null||typeof t!="object"||t===null)return!1;if(e instanceof Map&&t instanceof Map){if(e.size!==t.size)return!1;for(const[i,o]of e)if(!t.has(i)||!Object.is(o,t.get(i)))return!1;return!0}if(e instanceof Set&&t instanceof Set){if(e.size!==t.size)return!1;for(const i of e)if(!t.has(i))return!1;return!0}const n=Object.keys(e);if(n.length!==Object.keys(t).length)return!1;for(let i=0;i<n.length;i++)if(!Object.prototype.hasOwnProperty.call(t,n[i])||!Object.is(e[n[i]],t[n[i]]))return!1;return!0}const F=s.createContext(null);function Xe(){return typeof document>"u"?F:window.__TSR_ROUTER_CONTEXT__?window.__TSR_ROUTER_CONTEXT__:(window.__TSR_ROUTER_CONTEXT__=F,F)}function me(e){const t=s.useContext(Xe());return Ie(!(((e==null?void 0:e.warn)??!0)&&!t),"useRouter must be used inside a <RouterProvider> component!"),t}function B(e){const t=me({warn:(e==null?void 0:e.router)===void 0}),n=(e==null?void 0:e.router)||t,i=s.useRef(void 0);return Ue(n.__store,o=>{if(e!=null&&e.select){if(e.structuralSharing??n.options.defaultStructuralSharing){const u=ue(i.current,e.select(o));return i.current=u,u}return e.select(o)}return o})}const Be=s.createContext(void 0),Ye=s.createContext(void 0);function Je(e){const t=s.useContext(e.from?Ye:Be);return B({select:i=>{const o=i.matches.find(u=>e.from?e.from===u.routeId:u.id===t);if(Ne(!((e.shouldThrow??!0)&&!o),`Could not find ${e.from?`an active match from "${e.from}"`:"a nearest match!"}`),o!==void 0)return e.select?e.select(o):o},structuralSharing:e.structuralSharing})}const Ze=typeof window<"u"?s.useLayoutEffect:s.useEffect;function Qe(e,t,n={},i={}){const o=s.useRef(typeof IntersectionObserver=="function"),u=s.useRef(null);return s.useEffect(()=>{if(!(!e.current||!o.current||i.disabled))return u.current=new IntersectionObserver(([f])=>{t(f)},n),u.current.observe(e.current),()=>{var f;(f=u.current)==null||f.disconnect()}},[t,n,i.disabled,e]),u.current}function et(e){const t=s.useRef(null);return s.useEffect(()=>{e&&(typeof e=="function"?e(t.current):e.current=t.current)}),t}function tt(e,t){const n=me(),[i,o]=s.useState(!1),u=s.useRef(!1),f=et(t),{activeProps:m=()=>({className:"active"}),inactiveProps:v=()=>({}),activeOptions:d,to:y,preload:p,preloadDelay:z,hashScrollIntoView:a,replace:r,startTransition:x,resetScroll:b,viewTransition:_,children:E,target:T,disabled:w,style:D,className:$,onClick:h,onFocus:l,onMouseEnter:N,onMouseLeave:I,onTouchStart:M,ignoreBlocker:ge,...xe}=e,{params:mt,search:pt,hash:gt,state:xt,mask:yt,reloadDocument:wt,...Z}=xe,Q=s.useMemo(()=>{try{return new URL(`${y}`),"external"}catch{}return"internal"},[y]),ye=B({select:g=>g.location.search,structuralSharing:!0});e={from:Je({strict:!1,select:g=>g.pathname}),...e};const R=s.useMemo(()=>n.buildLocation(e),[n,e,ye]),L=s.useMemo(()=>e.reloadDocument?!1:p??n.options.defaultPreload,[n.options.defaultPreload,p,e.reloadDocument]),we=z??n.options.defaultPreloadDelay??0,W=B({select:g=>{if(d!=null&&d.exact){if(!Ke(g.location.pathname,R.pathname,n.basepath))return!1}else{const S=V(g.location.pathname,n.basepath).split("/");if(!V(R.pathname,n.basepath).split("/").every((Te,Ee)=>Te===S[Ee]))return!1}return((d==null?void 0:d.includeSearch)??!0)&&!X(g.location.search,R.search,{partial:!(d!=null&&d.exact),ignoreUndefined:!(d!=null&&d.explicitUndefined)})?!1:d!=null&&d.includeHash?g.location.hash===R.hash:!0}}),k=s.useCallback(()=>{n.preloadRoute(e).catch(g=>{console.warn(g),console.warn(Me)})},[e,n]),be=s.useCallback(g=>{g!=null&&g.isIntersecting&&k()},[k]);if(Qe(f,be,{rootMargin:"100px"},{disabled:!!w||L!=="viewport"}),Ze(()=>{u.current||!w&&L==="render"&&(k(),u.current=!0)},[w,k,L]),Q==="external")return{...Z,ref:f,type:Q,href:y,...E&&{children:E},...T&&{target:T},...w&&{disabled:w},...D&&{style:D},...$&&{className:$},...h&&{onClick:h},...l&&{onFocus:l},...N&&{onMouseEnter:N},...I&&{onMouseLeave:I},...M&&{onTouchStart:M}};const _e=g=>{if(!w&&!rt(g)&&!g.defaultPrevented&&(!T||T==="_self")&&g.button===0){g.preventDefault(),De.flushSync(()=>{o(!0)});const S=n.subscribe("onResolved",()=>{S(),o(!1)});return n.navigate({...e,replace:r,resetScroll:b,hashScrollIntoView:a,startTransition:x,viewTransition:_,ignoreBlocker:ge})}},ee=g=>{w||L&&k()},$e=ee,Se=g=>{if(w)return;const S=g.target||{};if(L){if(S.preloadTimeout)return;S.preloadTimeout=setTimeout(()=>{S.preloadTimeout=null,k()},we)}},ze=g=>{if(w)return;const S=g.target||{};S.preloadTimeout&&(clearTimeout(S.preloadTimeout),S.preloadTimeout=null)},C=g=>S=>{var G;(G=S.persist)==null||G.call(S),g.filter(Boolean).forEach(ie=>{S.defaultPrevented||ie(S)})},K=W?re(m,{})??{}:{},q=W?{}:re(v,{}),te=[$,K.className,q.className].filter(Boolean).join(" "),ne={...D,...K.style,...q.style};return{...Z,...K,...q,href:w?void 0:R.maskedLocation?n.history.createHref(R.maskedLocation.href):n.history.createHref(R.href),ref:f,onClick:C([h,_e]),onFocus:C([l,ee]),onMouseEnter:C([N,Se]),onMouseLeave:C([I,ze]),onTouchStart:C([M,$e]),disabled:!!w,target:T,...Object.keys(ne).length&&{style:ne},...te&&{className:te},...w&&{role:"link","aria-disabled":!0},...W&&{"data-status":"active","aria-current":"page"},...i&&{"data-transitioning":"transitioning"}}}function nt(e){return s.forwardRef(function(n,i){return ve.jsx(it,{...n,_asChild:e,ref:i})})}const it=s.forwardRef((e,t)=>{const{_asChild:n,...i}=e,{type:o,ref:u,...f}=tt(i,t),m=typeof i.children=="function"?i.children({isActive:f["data-status"]==="active"}):i.children;return typeof n>"u"&&delete f.disabled,s.createElement(n||"a",{...f,ref:u},m)});function rt(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}const ot=()=>{const e=s.useContext(ke);if(!e)throw new Error("useScreenWidth must be used within an ProviderScreenWidth");return e},at=J.div`
  display: contents;
`,st=c`
  ${e=>lt({...Ce[e.$size??"medium"]})};
`,lt=e=>c`
  display: flex;

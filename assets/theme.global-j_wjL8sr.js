import{l as s,f as a}from"./styled-components.browser.esm-CCP31c1y.js";import{J as n}from"./theme-6wvtFABo.js";var r=function(e,t){return Object.defineProperty?Object.defineProperty(e,"raw",{value:t}):e.raw=t,e},l=s(i||(i=r([`
...
`])));a(o||(o=r(["",""],["",""])),l);var i,o;const b=a`
  ...
  :root {
    ...
    --font-weight: 400;
    --font-size: ${e=>e.theme.defaultFontSize.desktop}px;
    --font-line-height: ${e=>e.theme.defaultLineHeight};
    --scrollbar-width: 4px;
    ...
    --heading-line-height: ${e=>e.theme.defaultLineHeight};
  ...
  * {
  ...
  @media (max-width: ${e=>e.theme.screens.tablet.width}) {
    :root {
      --font-size: ${e=>e.theme.defaultFontSize.tablet}px;
    }
  }

  @media (max-width: ${e=>e.theme.screens.mobile.width}) {
    :root {
      --font-size: ${e=>e.theme.defaultFontSize.mobile}px;
    }
  }
`;export{b as J};

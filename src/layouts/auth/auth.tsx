...
export const AuthLayout: FC<AuthLayoutProps> = (props) => {
  ...
  useGSAP(
    () => {
      ...
      if (currentBackground && currentChildren) {
        const computedStyle = getComputedStyle(currentBackground)

        const currentWidth = computedStyle.width
        const currentHeight = computedStyle.height
        gsap.set(currentChildren, {
          opacity: 0,
          pointerEvents: 'none'
        })
        gsap.fromTo(
        ...
        >
          <g filter="url(#filter0_d_2171_4468)">
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M246.697 46.6696V13.9215H258.364C262.404 13.9215 265.692 15.4571 268.229 18.5282C270.766 21.5994 272.035 25.5719 272.035 30.4458C272.035 35.2862 270.766 39.2087 268.229 42.2131C265.725 45.1841 262.437 46.6696 258.364 46.6696H246.697ZM257.814 40.9112H252.756V19.5798H257.814C260.451 19.5798 262.47 20.4978 263.873 22.3338C265.275 24.1699 265.976 26.7904 265.976 30.1954C265.976 33.6338 265.258 36.2877 263.822 38.1571C262.42 39.9931 260.417 40.9112 257.814 40.9112Z"
              fill="white"
            />
            <path
              d="M132.478 32.2985C132.478 30.9298 132.06 29.8449 131.226 29.0437C130.425 28.2092 129.373 27.7919 128.071 27.7919C126.736 27.7919 125.634 28.2258 124.766 29.0938C123.898 29.9283 123.464 31.03 123.464 32.3986V46.6696H117.406V23.6358H123.464L121.912 29.5945L122.797 29.9086C123.125 28.2513 123.799 26.7779 124.816 25.4885C126.352 23.5523 128.322 22.5842 130.725 22.5842C132.928 22.5842 134.781 23.4688 136.283 25.2381C137.786 27.0074 138.537 29.1772 138.537 31.7477V46.6696H132.478V32.2985Z"
              fill="white"
            />
          </g>
          <defs>
            <filter
              id="filter0_d_2171_4468"
              x="0"
              y="0"
              width="282.034"
              height="61.7427"
